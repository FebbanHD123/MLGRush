...
public class RoundChoosingGui {
    ...
    public static String GUI_NAME = "§eAnzahl der Runden";
    ...
    public void open(Player player) {
        ...
        inv.setItem(26, new ItemBuilder(Material.BARRIER).setDisplayName(MLGRush.getMessage("guiname.cancel")).build());
